...
<img src="hooks-in-sequence.png" alt="Us" align="right" style="width:200px; margin-right:30px">
...
{{< excerpt src="lib/src/peek_a_boo_component.dart" section="ngOnInit" >}}
...
hooks](router/5) <!--TODO: subref !--> that allow us to tap into
...
{{< figure src="peek-a-boo.png" alt="Peek-a-boo" >}}
...
{{< excerpt src="lib/src/spy_directive.dart" section="spy-directive" >}}

You can apply the spy to any native or component element and it'll be initialized and destroyed
at the same time as that element.
Here it is attached to the repeated hero `<div>`

{{< excerpt src="lib/src/spy_component.html" section="template" >}}

Each spy's birth and death marks the birth and death of the attached hero `<div>`
with an entry in the *Hook Log* as seen here:

<img class="image-display" src="spy-directive.gif" alt="Spy Directive">
...
[Tutorial]({{< ref toh-4 >}}#oninit) and [HTTP]({{< ref server-communication >}}#oninit) chapter
show how.
...
{{< excerpt src="lib/src/after_changes_component.dart" section="ng-after-changes" >}}

The example component, `AfterChangesComponent`, has two input properties: `hero` and `power`.

{{< excerpt src="lib/src/after_changes_component.dart" section="inputs" >}}

The host `AfterChangesParentComponent` binds to them like this:

{{< excerpt src="lib/src/after_changes_parent_component.html" section="after-changes" >}}

Here's the sample in action as the user makes changes.

<img class="image-display" src="after-changes-anim.gif" alt="AfterChanges">
...
{{< excerpt src="lib/src/do_check_component.dart" section="ng-do-check" >}}

This code inspects certain _values-of-interest_, capturing and comparing their current state against previous values.
It writes a special message to the log when there are no substantive changes to the `hero` or the `power`
so you can see how often `DoCheck` is called. The results are illuminating:

<img class="image-display" src="do-check-anim.gif" alt="DoCheck">
...
{{< excerpt src="lib/src/after_view_component.dart" section="child-view" >}}

The `AfterViewComponent` displays this child view *within its template*:

{{< excerpt src="lib/src/after_view_component.dart" section="template" >}}

The following hooks take action based on changing values *within the child view*
which can only be reached by querying for the child view via the property decorated with
[@ViewChild]({{< param pubApi >}}/angular/latest/angular/ViewChild-class.html).
...
{{< excerpt src="lib/src/after_view_component.dart" section="do-something" >}}
...
[@ContentChild]({{< param pubApi >}}/ngdart/latest/angular/ContentChild-class.html).

{{< excerpt src="lib/src/after_content_component.dart" section="hooks" >}}
