...
When you're done with this page, the app should look like this {{< exref toh-2 >}}.

## Where you left off

Before you continue with this page of the Tour of Heroes,
verify that you have the following structure after [The Hero Editor]({{< ref toh-1 >}}) page.
...
{{< excerpt src="lib/app_component.dart" section="templateUrl" >}}
...
{{< excerpt src="lib/src/mock_heroes.dart" >}}
...
{{< excerpt src="lib/app_component.dart" section="heroes" >}}
...
<!-- TODO: our shortcode can't do this yet.
...
{{< alert >}}
  ...
  [Showing a list property with *ngFor]({{< ref displaying-data >}}#ngFor) section of the
  [Displaying Data]({{< ref displaying-data >}}) page and the
  [ngFor]({{< ref template-syntax >}}#ngFor) section of the
...
{{< alert >}}
  ...
  [Event binding]({{< ref template-syntax >}}#event-binding) section of the
  [Template Syntax]({{< ref template-syntax >}}) page.
{{< /alert >}}
...
{{< excerpt src="lib/app_component.dart" section="selected" >}}
...
{{< alert >}}
  ...
  [Structural Directives]({{< ref structural-directives >}}) page and the
  [Built-in directives]({{< ref template-syntax >}}#directives) section of the
  [Template Syntax]({{< ref template-syntax >}}) page.
{{< /alert >}}
...
{{< figure src="heroes-list-selected.png" caption="Selected hero" alt="Selected hero" >}}
...
{{< alert >}}
  ...
  Read more about the `[class]` binding in the [Template Syntax]({{< ref template-syntax >}}#ngClass "Template syntax: NgClass") guide.

[identical]: {{< param dartApi >}}/stable/dart-core/identical.html
{{< /alert >}}
...
{{< figure src="heroes-list-1.png"
alt="Output of heroes list app" width="320">}}
...
{{< alert context="info" >}}
  ...
  [Component Testing](../advanced/testing/components) page for details.
...
Your app should look like this {{< exref toh-2 >}}.
...
[coreDirectives]: {{< param pubApi >}}/ngdart/latest/angular/coreDirectives-constant.html
[implementation files]: {{< param www >}}/tools/pub/package-layout#implementation-files
[part 1]: {{< ref toh-1 >}}#component-directives
